...
from handler.user import jwt_required_authentication
...
def get_all_articles():
    ...
    result, total_pages = article_service.search_all_articles(
        page, limit, query)
...
def create_a_src_news():
    ...
    if user_check.role == "manager":
        ...
        src_article_create = article_service.create_new_src_article(
            name_article, url)
