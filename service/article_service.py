...
from datalayer.articles_datalayer import ArticleMysql
from flask import jsonify, request, url_for
from model.articles_model import ArticleOutput, Category, News
...
class ArticleService:
    ...
    def index_article(self, article):
        self.datalayer.add_news_to_elasticsearch(article)

    def search_articles(self, query):
        hits = self.datalayer.search_articles(query)
        articles = [self.datalayer.get_articles_by_id(
